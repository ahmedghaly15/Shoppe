...
final _sharedPrefProvider = FutureProvider<SharedPreferences>((ref) async {
  return await SharedPreferences.getInstance();
});

final cacheHelperProvider = FutureProvider.autoDispose<CacheHelper>((
  ref,
) async {
  final sharedPref = await ref.watch(_sharedPrefProvider.future);
  return CacheHelper(sharedPref);
});
