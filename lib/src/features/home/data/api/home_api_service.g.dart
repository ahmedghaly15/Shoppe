...
class _HomeApiService implements HomeApiService {
  ...
  Future<FetchOffersRequestResponse> fetchOffers(
    ...
    late FetchOffersRequestResponse _value;
    try {
      _value = FetchOffersRequestResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<FetchCategoriesResponse> fetchCategories() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<FetchProductsRequestResponse> fetchProducts(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<FetchProductsRequestResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late FetchProductsRequestResponse _value;
    try {
      _value = FetchProductsRequestResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
