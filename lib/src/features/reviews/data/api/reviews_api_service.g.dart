...
class _ReviewsApiService implements ReviewsApiService {
  ...
  Future<FetchProductReviewsRequestResponse> fetchProductReviews(
    String productId,
    FetchProductReviewsRequestBody body,
  ) async {
    ...
    final _options = _setStreamType<FetchProductReviewsRequestResponse>(
    ...
    late FetchProductReviewsRequestResponse _value;
    try {
      _value = FetchProductReviewsRequestResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
